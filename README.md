...
8. run `npm install`
9. Run `app.py`, then execute `cd client` and run `npm run dev`; the links to the messenger page will then become available.
10. Create a room and start the stream by pasting the link from Tailscale.
